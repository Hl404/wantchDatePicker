...
<script>
	...
	import { unser, anwerType2, commitAnwer2, getMobile, authCode, mobileCode, pointUser } from 'src/service/getData'
	...
	export default {
		...
		methods: {
			copyToClipboard() {
				...
				/*range.selectNode(document.getElementById('contents'));
			...
			async answerfun() {
				...
				let anwerlsit = await anwerType2();
